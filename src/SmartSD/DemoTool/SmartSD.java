	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btnSend.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				/* Android ×÷ÎªServerÊ±Ê¹ÓÃÒÔÏÂ´úÂë */
				/**********************************/
				strRet.delete(0, strRet.length());
				try {
					// ´´½¨·þÎñ¶ËServerSocket¶ÔÏó
					ServerSocket serverSocket = new ServerSocket(8001);

					// ServerSocket.accept()·½·¨ÓÃÓÚµÈ´ý¿Í·þÁ¬½Ó
					while (true) {
				...
				/* Android ×÷ÎªClientÊ±Ê¹ÓÃÒÔÏÂ´úÂë */
				/**********************************/
				/*
				 * try { //´´½¨SocketÁ¬½Ó¶ÔÏó £¨ipµØÖ·£¬¶Ë¿Ú£©
				 * updateStatus("try ok"); Socket socket = new
				 * Socket("192.168.1.193",8001); //PrintWriter·¢ËÍ¶ÔÏó
